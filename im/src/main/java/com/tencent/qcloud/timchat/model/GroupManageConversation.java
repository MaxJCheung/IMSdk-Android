...
//        context.startActivity(intent);
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return ImApplication.getContext().getResources().getString(R.string.summary_me)+
                            ImApplication.getContext().getResources().getString(R.string.summary_group_invite)+
                            to+
                            ImApplication.getContext().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                ImApplication.getContext().getResources().getString(R.string.summary_group_invite)+
                                ImApplication.getContext().getResources().getString(R.string.summary_me)+
                                ImApplication.getContext().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                ImApplication.getContext().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return ImApplication.getContext().getResources().getString(R.string.summary_me)+
                            ImApplication.getContext().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+ ImApplication.getContext().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return ImApplication.getContext().getString(R.string.conversation_system_group);
    }
