...
//        tv.setTextColor(ImApplication.getContext().getResources().getColor(isSelf() ? R.color.common_fff176 : R.color.common_white));
//        viewHolder.sender.setTextColor(ImApplication.getContext().getResources().getColor(isSelf()? R.color.common_fff176 : R.color.common_1097d0));
...
//        tv.setText(stringBuilder);
        getBubbleView2(viewHolder, stringBuilder.toString());
