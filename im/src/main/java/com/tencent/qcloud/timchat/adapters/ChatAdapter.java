...
//            viewHolder.rightDesc = (TextView) view.findViewById(R.id.rightDesc);
            ...
            viewHolder.chat_item_layout = (LinearLayout) view.findViewById(R.id.chat_item_layout);
        ...
        viewHolder.chat_item_layout.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        viewHolder.sender.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null != mOnItemClickListener) {
                    mOnItemClickListener.onItemClick();
    ...
    public class ViewHolder {
        ...
        public LinearLayout chat_item_layout;
    }
