...
import com.tencent.qcloud.presentation.ChatView;
        ...
        if (observable instanceof MessageEvent) {
            ...
            if (null != msg) {
                if (msg.getConversation().getType() == TIMConversationType.C2C) {
                    view.showC2CMessage(msg);
                }
//                else if (msg==null||msg.getConversation().getPeer().equals(conversation.getPeer())&&msg.getConversation().getType()==conversation.getType()){
//                    view.showMessage(msg);
//                }
                else if (msg.getConversation().getType() == TIMConversationType.Group) {
                    view.showMessage(msg);
                }
